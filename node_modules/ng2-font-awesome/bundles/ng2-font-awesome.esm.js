...
$__System.registerDynamic("5", ["3"], true, function ($__require, exports, module) {
    ...
    var FontAwesomeComponent = /** @class */function () {
        ...
        // ngOnInit sanitizes faIcon on init
        FontAwesomeComponent.prototype.ngOnInit =
        // ngOnInit sanitizes faIcon on init
        function () {};
        FontAwesomeComponent.decorators = [{ type: core_1.Component, args: [{
                // moduleId: module.id,
        ...
        /** @nocollapse */
        FontAwesomeComponent.ctorParameters = function () {
            return [];
        };
...
$__System.registerDynamic("1", ["2", "5"], true, function ($__require, exports, module) {
  "use strict";
